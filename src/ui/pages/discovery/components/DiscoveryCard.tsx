...
export const DiscoveryCard = memo(function DiscoveryCard({
  ...
  useEffect(() => {
    ...
    // Other catalogues serve artwork straight off a CDN, so there is nothing
    // to resolve; only Character Tavern needs the backend to build a URL.
    const direct = provider.imageUrl(card);
